...
=======
>>>>>>> b6f431130478b3be244f82627bfdffc5d66e61cd
...
//bool test_case_1() {
    ...
    //     cout<<"fail_1"<<" : "<<dijkstra("UGL", "ARC", test_routes.routes_map).first<<endl;
    // }
    // if (!equal(dijkstra("UGL", "ARC", test_routes.routes_map).second.begin(), 
    //         dijkstra("UGL", "ARC", test_routes.routes_map).second.end(), 
    //         vector<string>("UGL", "ARC").begin())) {
    //     cout<<"fail_2"<<endl;
    //     return false;
    // }
    REQUIRE(test_routes.routes_map[UGL].second[0] < test_routes.routes_map[UGL].second[2]);
